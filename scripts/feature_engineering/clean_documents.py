...
from services.application.preprocessing.dispatchers import CleaningDispatcher
...
def clean_documents(
    ...
    for document in documents:
        ...
        logger.info(f"cleaned_document type = {type(cleaned_document)}")
...
def _get_metadata(cleaned_documents: list[CleanedDocument]) -> dict:
    ...
    for document in cleaned_documents:
        ...
        metadata[category]["authors"].append(document.author_user_name)
